...
def get_dataset(dataset_name='abaaba'):
    ...
    if dataset_name == 'ogbg-molpcba':
        ...
        dataset = {
            ...
            'train_dataset': MyZINCDataset(subset=True, root='../data_zinc', split='train'),
            'valid_dataset': MyZINCDataset(subset=True, root='../data_zinc', split='val'),
            'test_dataset': MyZINCDataset(subset=True, root='../data_zinc', split='test'),
            'max_node': 128,
        }
    else:
